...
const ADMIN_NAV = [
  { href: '/admin/dashboard', label: 'Dashboard', icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z', adminOnly: true },
  { href: '/admin/summary', label: 'Business Summary', icon: 'M9 17v-2m3 2v-6m3 6v-4M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z', adminOnly: true },
  ...
  { href: '/admin/complaints', label: 'Complaints', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z', adminOnly: true },
  { href: '/admin/pages', label: 'Pages & Nav', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16', adminOnly: true },
