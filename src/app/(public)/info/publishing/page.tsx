    ...
    <main style={{ background: '#0d0f18', minHeight: '100vh', fontFamily: 'var(--brand-font, Poppins, sans-serif)', color: '#fff' }}>
      ...
      <section style={{ padding: '100px 40px 80px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-0.03em', marginBottom: 24, maxWidth: 700 }}>
          Your words deserve<br /><span style={{ color: '#d42020' }}>a professional stage.</span>
        </h1>
      ...
      <section style={{ padding: '0 40px 80px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(300px,1fr))', gap: 2 }}>
          {SERVICES.map(({ title, desc }) => (
            <div key={title} style={{ background: '#111320', padding: '32px 28px', borderRight: '2px solid #d42020' }}>
