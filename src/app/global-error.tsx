    ...
    <html lang="en">
      <body style={{ margin: 0, background: '#0d1017', fontFamily: 'system-ui,sans-serif', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', padding: '40px 24px', maxWidth: 480 }}>
          ...
          <button
            onClick={reset}
            style={{ padding: '12px 28px', background: '#d42020', color: '#fff', border: 'none', fontWeight: 800, fontSize: 12, cursor: 'pointer', letterSpacing: '0.06em', textTransform: 'uppercase' }}
          >
            Try again
          </button>
        </div>
